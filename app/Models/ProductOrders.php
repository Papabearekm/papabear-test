...
class ProductOrders extends Model
{
    ...
    protected $fillable = ['uid','freelancer_id','salon_id','driver_id','date_time','paid_method','order_to','orders','notes','address',
    ...
    {
        return $this->belongsTo(Payments::class, 'paid_method', 'id');
    }
}
