...
class PackagesController extends Controller
{
    ...
    public function getPackageById(Request $request){
        ...
        $data->services = SalonService::join('services', 'salon_services.service_id', '=', 'services.id')
        ->whereIn('salon_services.id', $ids)
        ->select('salon_services.id', 'salon_services.cover', 'salon_services.price', 'services.name', 'salon_services.gender')
        ->get();
    ...
    public function getBySalonID(Request $request){
        ...
        foreach($data as $loop){
            ...
            $loop->services = SalonService::join('services', 'salon_services.service_id', '=', 'services.id')
            ->whereIn('salon_services.id', $ids)
            ->select('salon_services.id', 'salon_services.cover', 'salon_services.price', 'services.name', 'salon_services.gender')
            ->get();
