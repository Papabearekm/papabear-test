...
class ChatRoomsController extends Controller
{
    ...
    public function getChatListBUid(Request $request){
        ...
        ->get();
        foreach($data as $dat) {
            $last_message = Conversions::where('room_id', $dat->message_id)->latest('id')->first();
            $dat->last_message_time = $last_message ? $last_message->updated_at : $dat->updated_at;
        }
        $response = [
            'data'=>$data,
            'success' => true,
