...
class Create extends Component
{
    ...
    #[Rule('required')]
    public $coupon_code, $name, $short_descriptions, $discount, $upto, $type=1, $max_usage, $min_cart, $expiry_date;
    ...
    {
        return view('livewire.offer.create')->extends('layouts.master');
    }
}
