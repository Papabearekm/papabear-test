...
use App\Http\Controllers\v1\FacilitiesController;
...
use App\Http\Controllers\v1\PartnerAdsController;
...
use App\Http\Controllers\v1\AppointmentCompletionController;
...
use App\Http\Controllers\v1\WithdrawalController;
...
Route::prefix('/v1')->group(function () {
    ...
    Route::post('auth/createAgentAccount', [AuthController::class, 'createAgentAccount']);
    ...
    // Route::group(['middleware' => ['jwt', 'jwt.auth']], function () {
        ...
        Route::post('category/getServicesById', [CategoryController::class, 'getServicesById']);


        // Banners Routes
        Route::post('ads/create',[BannersController::class, 'save'] );
        ...
        Route::get('ads/getAll', [BannersController::class, 'getAll']);
        Route::post('ads/getAllAdded', [BannersController::class, 'getAllAdded']);
        Route::get('banners/getMoreData', [BannersController::class, 'getMoreData']);
        Route::post('ads/update', [BannersController::class, 'update']);
        Route::post('ads/destroy', [BannersController::class, 'delete']);

        // Partner Ads Routes
        Route::get('partner-ads/getAll', [PartnerAdsController::class, 'getAll']);
        ...
        Route::get('services/', [ServicesController::class, 'getCompleteServices']);
        Route::get('services/{keyword}', [ServicesController::class, 'searchServices']);
        ...
        Route::post('appointments/cancel',[AppointmentsController::class, 'cancel']);
        Route::post('appointments/complete',[AppointmentCompletionController::class, 'store']);
        ...
        Route::post('offers/getStores', [OffersController::class, 'getStores']);
        ...
        Route::post('offers/getCouponByUserId', [OffersController::class, 'getCouponByUserId']);
        ...
        // facilities routes
        Route::post('facilities/getAll', [FacilitiesController::class, 'getAll']);
        Route::get('facilities/index', [FacilitiesController::class, 'index']);
        ...
        Route::post('notifications/all', [NotificationController::class, 'index']);
        Route::post('notifications/read', [NotificationController::class, 'update']);
        ...
        Route::post('complaints/getComplaintsByUser', [ComplaintsController::class, 'getComplaintsByUser']); // New API
        ...
        // Agent Adding Salon
        Route::post('agents/registerSalon', [AgentController::class, 'registerSalon']);

        //Upgrade of salon to premium
        Route::post('salon/upgrade', [SalonController::class, 'upgradeSalon']);
        
        //Upgrade of freelancer to premium
        Route::post('individual/upgrade', [IndividualController::class, 'upgradeIndividual']);

        //Check premium status
        Route::post('premium/check', [IndividualController::class, 'checkPremium']);

        // Withdrawals
        Route::post('withdrawals/history', [WithdrawalController::class, 'index']);
        Route::post('withdrawals/filter', [WithdrawalController::class, 'filter']);
        Route::post('withdrawals/create', [WithdrawalController::class, 'store']);

        // Holidays
        Route::post('holidays/mark-holiday', [HolidayController::class, 'store']);
        Route::post('holidays/check-holiday', [HolidayController::class, 'index']);
    ...
    Route::get('filters', [SalonController::class, 'filters']);
    Route::post('home/getBannerData', [SalonController::class, 'getBannerData']);
    ...
    Route::post('sendMailToAdmin',[ContactsController::class, 'sendMailToAdmin']);http://127.0.0.1:8000/admin/categories
    ...
    Route::get('appointments/printCommissionInvoice', [AppointmentsController::class, 'printCommissionInvoice']);
    ...
    Route::get('product_order/printCommissionInvoice', [ProductOrdersController::class, 'printCommissionInvoice']);
    ...
    Route::post('appointments/getPrevious', [AppointmentsController::class, 'getPreviousAppointements']);

    Route::post('salon/check-cod', [SalonController::class, 'checkCOD']);
