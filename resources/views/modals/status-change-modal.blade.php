<div id="confirm_modal" wire:ignore.self class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="form-group mb-3">
                    <div class="col-lg-12 text-center">
                        ...
                        <p style="font-weight: 300px;font-size:18px;">{{ __('Status will be change.') }}</p>
                    </div>
                </div>
                <div class="row">
                    <form wire:submit.prevent="status_change">
