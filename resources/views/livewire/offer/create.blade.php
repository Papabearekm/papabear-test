                ...
                <div class="card-body">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="short_descriptions" wire:model="short_descriptions"
                                        value="{{ old('short_descriptions') }}" class="form-control" id="formrow-email-input">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="coupon_code" wire:model="coupon_code"
                                        value="{{ old('coupon_code') }}" class="form-control" id="formrow-email-input">
                                    @error('coupon_code')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="discount" wire:model="discount"
                                        value="{{ old('discount') }}" class="form-control" id="formrow-email-input">
                                    @error('discount')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min_cart" wire:model="min_cart"
                                        value="{{ old('min_cart') }}" class="form-control" id="formrow-email-input">
                                    @error('min_cart')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="expiry_date" wire:model="expiry_date"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('Tick Partners or Freelancers') }}</label> <br>
                                    <div class="row">
                                        @foreach ($users as $user)
                                        <div class="col-md-2">
                                            <label>
                                                <input type="checkbox" wire:model="selectedFreelancers" class="form-check-input"
                                                id="formrow-email-input-{{ $user->id }}" value="{{ $user->id }}">
                                                {{ $user->first_name }} {{ $user->last_name }}
                                            </label>
                                        </div>
                                        @endforeach
                                    </div>
                                    @error('selectedFreelancers')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
