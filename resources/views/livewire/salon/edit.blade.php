            ...
            <div class="card">
                <div class="card-body">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <center>
                                        ...
                                        @elseif ($image_preview)
                                            <img src="{{ Storage::disk('spaces')->url($user->salon->cover) }}" alt="preview"
                        ...
                        <div class="row">
                            <h4 class="p-3 text-info">Owner Details</h4>
                            <div class="col-md-4">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <h4 class="p-3 text-info">Shop Details</h4>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="formrow-email-input"
                                        class="form-label">{{ __('Partner Name') }}</label>
                                    <input type="text" name="salon_name" wire:model="salon_name"
                                        value="{{ old('salon_name') }}" class="form-control"
                                        id="formrow-email-input">
                                    @error('salon_name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="formrow-email-input"
                                        class="form-label">{{ __('About Partner') }}</label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="formrow-email-input"
                                        class="form-label">{{ __('Partner Address') }}</label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="formrow-email-input"
                                        class="form-label">{{ __('Partner City') }}</label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @elseif ($id_proof_preview && $user->salon->id_proof)
                                        <div class="mb-2 text-center">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @elseif ($id_proof_back_preview && $user->salon->id_proof_back)
                                        <div class="mb-2 text-center">
                            ...
                            <col-md-12>
                                <div class="mb-3">
                                    <label for="formrow-email-input" class="form-label">{{ __('Facilities') }}</label>
                                    <div class="row">
                                        @foreach ($facilities as $facility)
                                            <div class="col-md-2">
                                                <input type="checkbox" wire:model="selectedFacilities" class="form-check-input" value="{{ $facility->id }}"/>{{ $facility->name }}
                                            </div>
                                        @endforeach    
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            @if($heard_us_from == 'Executive')
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="formrow-email-input"
                                            class="form-label">{{ __('Select Executive') }}</label>
                                        <select name="agent_id" wire:model="agent_id" class="form-control">
                                            <option value="">-- select --</option>
