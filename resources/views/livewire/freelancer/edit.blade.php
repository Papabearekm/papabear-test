    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Edit Freelancer</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <center>
                                        ...
                                        @elseif ($image_preview)
                                            <img src="{{ Storage::disk('spaces')->url($user->cover) }}" alt="preview"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @elseif ($id_proof_preview && $user->individual->id_proof)
                                        <div class="mb-2 text-center">
                                            <img src="{{ Storage::disk('spaces')->url($id_proof_preview) }}" alt="ID Proof Front Preview" width="100" height="100" class="border" style="object-fit: cover;">
                                        </div>
                                    @endif
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @elseif ($id_proof_back_preview && $user->individual->id_proof_back)
                                        <div class="mb-2 text-center">
                                            <img src="{{ Storage::disk('spaces')->url($id_proof_back_preview) }}" alt="ID Proof Back Preview" width="100" height="100" class="border" style="object-fit: cover;">
                                        </div>
                                    @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="fee_start" wire:model="fee_start"
                                        value="{{ old('fee_start', $fee_start) }}" class="form-control" id="formrow-email-input">
                                    @error('fee_start')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="pan" wire:model="pan"
                                        value="{{ old('pan', $pan) }}" class="form-control" id="formrow-email-input">
                                    @error('pan')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="vat" wire:model="vat"
                                        value="{{ old('vat', $vat) }}" class="form-control" id="formrow-email-input">
                                    @error('vat')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="heard_us_from" wire:model.live="heard_us_from" class="form-control">
                                        ...
                                        <option value="Executive" {{ $heard_us_from == 'Executive' ? 'selected' : '' }}>Executive</option>
                                        <option value="Google" {{ $heard_us_from == 'Google' ? 'selected' : '' }}>Google</option>
                                        <option value="Social Media" {{ $heard_us_from == 'Social Media' ? 'selected' : '' }}>Social Media</option>
                                        <option value="Friends" {{ $heard_us_from == 'Friends' ? 'selected' : '' }}>Friends</option>
                                        <option value="Ads" {{ $heard_us_from == 'Ads' ? 'selected' : '' }}>Ads</option>
                                        <option value="News Paper" {{ $heard_us_from == 'News Paper' ? 'selected' : '' }}>News Paper</option>
                                        <option value="Others" {{ $heard_us_from == 'Others' ? 'selected' : '' }}>Others</option>
                                    </select>
                                    @error('heard_us_from')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="formrow-email-input" class="form-label">{{ __('Executive ID') }}</label>
                                    <select name="executive_id" wire:model="executive_id" class="form-control" id="formrow-email-input">
                                        <option value="">-- select --</option>
                                        @foreach ($executives as $executive)
                                            <option value="{{ $executive->id }}" {{ $executive_id == $executive->id ? 'selected' : '' }}>{{ $executive->first_name }} {{ $executive->last_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('executive_id')
                                        <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="whatsapp_number" wire:model="whatsapp_number"
                                        value="{{ old('whatsapp_number', $whatsapp_number) }}" class="form-control" id="formrow-email-input">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="team_size" wire:model="team_size"
                                        value="{{ old('team_size', $team_size) }}" class="form-control" id="formrow-email-input">
                                    @error('team_size')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
