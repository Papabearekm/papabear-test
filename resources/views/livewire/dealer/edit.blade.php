                    ...
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="formrow-email-input"
                                        class="form-label">{{ __('Id Proof Front') }}</label>
                                    <input type="file" name="id_proof" wire:model="id_proof"
                                        value="{{ old('id_proof') }}" class="form-control" id="formrow-email-input">
                                    @if ($id_proof)
                                        <img src="{{ $id_proof->temporaryUrl() }}" alt="preview" width="150"
                                            height="150" class="p-2">
                                    @elseif ($id_proof_preview)
                                        <img src="{{ Storage::disk('spaces')->url($id_proof_preview) }}"
                                            alt="preview" width="150" height="150" class="p-2">
                                    @else
                                        <img src="{{ asset('assets/images/dummy.jpeg') }}" alt="preview"
                                            width="150" height="150" class="p-2">
                                    @endif
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="formrow-email-input"
                                        class="form-label">{{ __('Id Proof Back') }}</label>
                                    <input type="file" name="id_proof_back" wire:model="id_proof_back"
                                        value="{{ old('id_proof_back') }}" class="form-control"
                                        id="formrow-email-input">
                                    @if ($id_proof_back)
                                        <img src="{{ $id_proof_back->temporaryUrl() }}" alt="preview" width="150"
                                            height="150" class="p-2">
                                    @elseif ($id_proof_back_preview)
                                        <img src="{{ Storage::disk('spaces')->url($id_proof_back_preview) }}"
                                            alt="preview" width="150" height="150" class="p-2">
                                    @else
                                        <img src="{{ asset('assets/images/dummy.jpeg') }}" alt="preview"
                                            width="150" height="150" class="p-2">
